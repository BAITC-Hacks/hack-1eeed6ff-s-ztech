...
**Состояние реализации:** ядро, три CSV, API и интерфейс Алишера объединены. Поиск, направленный граф, основания ролей, альтернативы, исходные переводы, кластеры и скачивание CSV проверены на настоящих данных. 78 backend-тестов, 18 frontend-тестов, 12 браузерных contract-тестов и 3 сквозных сценария проходят. Новый clone на машине A и runtime с запрещёнными внешними соединениями проверены; независимый релизный запуск на втором ноутбуке и подача ещё ожидаются. [Актуальный статус](docs/hackalem/STATUS.md), [проверки](docs/validation.md), [журнал A](docs/progress/A.md), [журнал B](docs/progress/B.md).
