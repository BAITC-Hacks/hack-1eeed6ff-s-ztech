...
Переключатель солнце/луна в шапке меняет светлую и тёмную тему, сохраняя выбранный узел и положение графа. Стрелка «На главный экран» возвращает из узла или кластера к обзору и очищает поиск и фильтры. Настройка темы сохраняется локально.
