...
**Реализованы данные, граф, роли, кластеры, объяснения и три CSV в `results/`; 43 Python-теста проходят. Raw→проверенный CSV: 0,808 с на Apple M4/macOS. API и пользовательский запуск ещё разрабатываются; UI ожидается от Алишера.**
