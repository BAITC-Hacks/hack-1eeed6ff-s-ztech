...
def main(argv=None):
    ...
    try:
        ...
        if not args.pipeline_only and not args.api_only and not (web_dist / "index.html").is_file():
            raise ValueError(
        ...
        if args.pipeline_only:
            return 0
        application = create_app(snapshot, args.out, None if args.api_only else web_dist)
